...
class RentAdd extends Component {
  ...
  addHouse = async () => {
    ...
    // 请求
    const res = await this.$axios.post('/houses/image',
      formData,{
        headers:{
    ...
    const res1 = await this.$axios.post('/user/houses',{
      title,
      description,
      houseImg,
      oriented,
  ...
  render() {
    ...
    return (
      <div className={styles.root}>
        <NavHeader className={styles.title}>发布房源</NavHeader>
